...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bground_ui.setMinimumSize(QtCore.QSize(40, 50))
        self.bground_ui.setObjectName("bground_ui")
        self.verticalLayout_3.addWidget(self.bground_ui)
        self.main_ui = QtWidgets.QPushButton(parent=self.centralwidget)
        self.main_ui.setMinimumSize(QtCore.QSize(0, 35))
        self.main_ui.setObjectName("main_ui")
        self.verticalLayout_3.addWidget(self.main_ui)
